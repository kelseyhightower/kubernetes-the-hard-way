...
```
curl -o kubectl https://storage.googleapis.com/kubernetes-release/release/v1.13.1/bin/darwin/amd64/kubectl
```
...
Verify `kubectl` version 1.13.1 or higher is installed:
