...
**Note**: Please ensure you've imported the shell functions defined [here](02-client-tools.md#shell-helper-functions), either within your shell profile or explicitly within each tmux window/pane.
